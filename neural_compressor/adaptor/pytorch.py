    ...
    def quantize(self, tune_cfg, model, dataloader, calib_func=None):
        ...
        for key, config in tune_cfg["op"].items():
            ...
            if config["weight"]["dtype"] == "fp32":
                ...
                if dtype in ["nf4", "nf3",  "nf3_nz", "sf4_3", "sf3_3", "sf3_3_nz", "sf4_4", "sf3_4", "sf3_4_nz", "sf4_5", "sf3_5", "sf4_6", "sf3_6", "sf3_6_nz", "sf4_7", "fp4", "fp4_e2m1_bnb", "fp4_e2m1",
                             "fp4_e1m2", "fp4_basic", "fp4_no_sub", "fp4_range", "fp4_prec1",
                             "fp4_prec2", "fp4_log", "fp3_log", "en_25",
                             "apot4", "apot4-sp", "mokey", "denorm4"]:
